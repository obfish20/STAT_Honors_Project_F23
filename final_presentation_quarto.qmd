...
```{r echo=FALSE}
table(camera_df$Forest) |> knitr::kable()
```

## Data exploration

```{r echo=FALSE}
table(camera_df$choice) |> pander::pander()
```
...
## Animation (deer)
```{r echo=FALSE, include=FALSE}
map_out_deer <- map(date_vec, get_interval_data,
...
## Thanks to Erika barthelmess and Dr. Higham
